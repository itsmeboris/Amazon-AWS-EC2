...
public class awsVars {
    ...
    static final String APP_INPUT_QUEUE_NAME = "app-input-queue";
    static final String APP_OUTPUT_QUEUE_NAME = "app-output-queue";
    static final String MNG_INPUT_QUEUE_NAME = "mng-input-queue";
    static final String MNG_OUTPUT_QUEUE_NAME = "mng-output-queue";
